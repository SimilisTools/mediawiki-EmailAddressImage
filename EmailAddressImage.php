...
call_user_func( function() {
	...
	$GLOBALS['wgExtensionMessagesFiles']['AdvancedRandom'] = dirname(__FILE__) . '/EmailAddressImage.i18n.php';
	$GLOBALS['wgHooks']['ParserFirstCallInit'][] = 'emailAddressImage';
...
function doAddressImage( $input, array $args, Parser $parser, PPFrame $frame ) {
	...
	$email_pattern = '/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,8}\b/';
